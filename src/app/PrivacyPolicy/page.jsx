  ...
  return (
    <>
      <div className="about-banner">
        <h1 className="about-shrveg">PRIVACY POLICY</h1>
        <div className="about-banner-img about-banner-img2">
          ...
          <p>
            ...
            relation to the sharing of your personal information with us. By
            accepting the privacy policy and the user agreement or the use of
            the site in general, you give your consent to our use and disclosure
            ...
            the User Agreement. This privacy policy is effective upon acceptance
            of access by you to the site.
          </p>
          ...
          <h4>COOKIE POLICY</h4>
          <p>
            <Link href="https://www.shriveg.com/">shriveg.com</Link>operates a
            strict privacy policy and we are committed to being transparent
          ...
          <p>
            ...
            that determine how long they stay in your browser:
          </p>
          <p>
          ...
          <p>
            ...
            stay in your browser until they expire, or until you manually delete
            them. For example we use persistent cookies to better understand
            usage patterns so that we can improve the site for our customers.
          </p>
          <p>
            <b>Cookies are grouped into the following categories: </b> 
          ...
          <p>
            ...
            understand things including how many people visit our websites, how
          ...
          <p>
            ...
            interest you. You might see these advertisements on our sites on
            other sites you visit. These cookies record your visit to our
            website and the content you interact with. They may be placed by us,
            or by advertising partners with our permission.
          </p>
          <p>
          ...
          <p>
            ...
            enable us deliver advertising. These sources are validated by Third
            party, and not by us.
          </p>
          <p>
